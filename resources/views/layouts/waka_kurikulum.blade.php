...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .sidebar-subtitle { font-size: 11.5px; color: #707e94; font-weight: 600; margin-top: 2px; letter-spacing: 0.3px; }
        ...
        .sidebar-menu li.active a {
            color: #0ea5e9; background-color: #ffffff;
            box-shadow: 0 4px 12px rgba(14, 165, 233, 0.1); font-weight: 700;
        }
        .sidebar-menu li.active a::before {
            content: ''; position: absolute; right: -20px; top: 50%;
            transform: translateY(-50%); width: 4px; height: 24px;
            background-color: #0ea5e9; border-radius: 4px 0 0 4px;
        }
        .sidebar-menu li a:hover:not(.active) { background-color: #e0f2fe; color: #0369a1; }
        ...
        .sidebar-bottom a:hover { background-color: #e0f2fe; }
        ...
        .profile-dropdown {
            ...
            width: 260px; background: white; border-radius: 16px;
        ...
        .logout-modal-overlay {
            ...
            background: rgba(15,23,42,0.55); z-index: 10000;
        ...
        .logout-modal-icon {
            width: 60px; height: 60px; border-radius: 18px; background: #fef2f2;
        ...
        .mobile-topbar {
            ...
            height: 62px; padding: 0 16px; align-items: center;
            justify-content: space-between; position: sticky; top: 0; z-index: 9980;
        }
        ...
        .sidebar-backdrop {
            display: none; position: fixed; inset: 0; background: rgba(0,0,0,0.5); z-index: 9989;
        }
    ...
    <aside class="sidebar">
        <div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-category-header">Monitoring Pembelajaran</li>
    ...
    <main class="main-wrapper">
        <header class="top-header-banner">
            <div class="header-title-box">
                ...
                <p>@yield('header_subtitle', 'Monitoring Pembelajaran & Ketercapaian Jurnal Mengajar')</p>
            </div>
            <div class="header-user-nav">
                @yield('header_extra')
                <div class="profile-dropdown-wrap" id="profileDropdownWrap">
                    <div class="user-profile-badge" onclick="toggleProfileDropdown()">
                        <img src="{{ Auth::user()->photo ? Storage::url(Auth::user()->photo) : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name ?? 'Waka K').'&background=0ea5e9&color=ffffff&bold=true' }}" alt="Avatar" class="avatar-img">
