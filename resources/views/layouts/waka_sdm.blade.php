...
<head>
    ...
    <style>
        * { box-sizing: border-box; margin: 0; padding: 0; font-family: 'Plus Jakarta Sans', sans-serif; }
        ...
        .sidebar-menu li.active a { color: #8b5cf6; background-color: #ffffff; box-shadow: 0 4px 12px rgba(139,92,246,0.1); font-weight: 700; }
        .sidebar-menu li.active a::before { content: ''; position: absolute; right: -20px; top: 50%; transform: translateY(-50%); width: 4px; height: 24px; background-color: #8b5cf6; border-radius: 4px 0 0 4px; }
        .sidebar-menu li a:hover:not(.active) { background-color: #ede9fe; color: #7c3aed; }
        ...
        .sidebar-bottom a:hover { background-color: #ede9fe; }
        ...
        .d-role { display: inline-block; margin-top: 6px; font-size: 10.5px; font-weight: 700; background: #ede9fe; color: #7c3aed; padding: 2px 8px; border-radius: 6px; }
...
<body>
    <div class="mobile-topbar">
        <div class="mobile-topbar-left">
            ...
            <div class="mobile-brand">
                ...
                <span class="mobile-brand-title">WAKA SDM</span>
            </div>
        </div>
    </div>
    ...
    <aside class="sidebar">
        <div>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="sidebar-category-header">Monitoring SDM</li>
                <li class="{{ request()->routeIs('waka-sdm.guru') ? 'active' : '' }}">
                    <a href="{{ route('waka-sdm.guru') }}">
    ...
    <main class="main-wrapper">
        <header class="top-header-banner">
            <div class="header-title-box">
                <h1>@yield('header_title', 'Portal Waka SDM')</h1>
                <p>@yield('header_subtitle', 'Monitoring Kehadiran & Kepegawaian Guru SMKN 1 Boyolangu')</p>
            </div>
            <div class="header-user-nav">
                @yield('header_extra')
                <div class="profile-dropdown-wrap" id="profileDropdownWrap">
                    <div class="user-profile-badge" onclick="toggleProfileDropdown()">
                        <img src="{{ Auth::user()->photo ? Storage::url(Auth::user()->photo) : 'https://ui-avatars.com/api/?name='.urlencode(Auth::user()->name ?? 'Waka SDM').'&background=8b5cf6&color=ffffff&bold=true' }}" alt="Avatar" class="avatar-img">
                        <div class="user-info-text">
                            <span class="user-name">{{ Auth::user()->name ?? 'Waka SDM' }}</span>
                            <span class="user-email">{{ Auth::user()->email }}</span>
                        </div>
                    </div>
                    <div class="profile-dropdown" id="profileDropdown">
                        <div class="dropdown-header">
                            <div class="d-name">{{ Auth::user()->name ?? 'Waka SDM' }}</div>
    ...
    <div class="logout-modal-overlay" id="logoutModalOverlay">
        <div class="logout-modal-card">
            ...
            <div class="logout-modal-desc">Apakah Anda yakin ingin keluar dari sistem?</div>
